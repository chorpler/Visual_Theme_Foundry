...
export const styles = css`:host {
  --_container-color: var(--md-navigation-drawer-modal-container-color, #fff);
  ...
  --_scrim-opacity: var(--md-navigation-drawer-modal-scrim-opacity, 0.04);
...
.md3-navigation-drawer-modal {
  ...
  top: 0;
  inline-size: 0;
  transition: inline-size 0.25s cubic-bezier(0.4, 0, 0.2, 1) 0s, visibility 0s cubic-bezier(0.4, 0, 0.2, 1) 0.25s;
}

.md3-navigation-drawer-modal--opened {
  transition: inline-size 0.25s cubic-bezier(0.4, 0, 0.2, 1) 0s, visibility 0s cubic-bezier(0.4, 0, 0.2, 1) 0s;
}
...
.md3-navigation-drawer-modal__scrim {
  ...
  transition: opacity 0.25s cubic-bezier(0.4, 0, 0.2, 1) 0s, visibility 0s cubic-bezier(0.4, 0, 0.2, 1) 0.25s;
}

.md3-navigation-drawer-modal--scrim-visible {
  visibility: visible;
  opacity: var(--_scrim-opacity);
  transition: opacity 0.25s cubic-bezier(0.4, 0, 0.2, 1) 0s, visibility 0s cubic-bezier(0.4, 0, 0.2, 1) 0s;
}
`;
